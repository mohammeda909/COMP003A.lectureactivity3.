...
namespace COMP003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // this is a simple array with 10 items in it. you will learn more about
            // arrays on module 7
             ...
             * evaluated after each execution of the loop, a do loop executes one or more times.
             ...
             * specified Boolean expression evaluates to true. Because that expression is
             * evaluated before each execution of the loop, a while loop executes zero or more times.
